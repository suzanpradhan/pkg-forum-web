      ...
      <div className="flex p-2  items-center ml-4 mr-4">
        ...
        <div className="relative w-1/2">
          <input
            ...
            className="w-full py-2 px-4 bg-[#070709] rounded-lg text-white text-sm placeholder-gray-500 text-center focus:outline-none focus:ring-2 focus:ring-orange-500 font-martian-mono"
          />
        ...
        <div className="flex items-center flex-1 space-x-4 justify-end">
          ...
          <button className="flex items-center px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg h-9">
            <SquarePen className="mr-2 h-4 font-martian-mono text-sm"  />
            Write
          </button>
