...
export default function NavBar() {
  return (
    <nav className=" items-center  bg-[#15161A] ">
      <div className="flex p-4 justify-center">
        ...
        <div className="relative w-1/2">
          <input
            ...
            className="w-full py-2 px-4 bg-[#070709] rounded-lg text-white placeholder-gray-500 text-center focus:outline-none focus:ring-2 focus:ring-orange-500 font-martian-mono text-custom-sm"
          />
