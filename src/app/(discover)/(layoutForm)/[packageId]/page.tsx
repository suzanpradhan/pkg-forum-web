...
export default function PostList({
  ...
  return (
    <div className="flex">
                ...
                <div className="mr-10 border-r border-gray-700">
                  <div className="container mx-auto -ml-14">
                    <div className="mt-4">
                      ...
                      <ButtonGroup />
                      <hr className="border-gray-700 mt-4 -ml-4 -mr-[90px]" />
                    </div>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="w-[108.5%] h-80 rounded-md overflow-hidden mb-4 mt-4 relative">
                        <ReactPlayer
      ...
      <div className="lg:w-1/4 sticky top-0 mt-28 bg-[#15161A]">
